...
<!--导航栏 end-->
<img src="../../static/img/logo.png" width="200" height="auto"/>
<div style="width:1000px;margin: auto;text-align: center  " class="modal-content">
    <h3>亲爱的 <span style="color:red; font-size: 18px">${user.userName}</span> 你好，你的订单 <span style="color:red; font-size: 18px">${orderNo}</span> 失败</h3>
    <h3>失败原因：</h3>
    <h4>
        <c:forEach items="${names}" var="name" varStatus="index">
            <div>${index.count}:${name}</div>
        </c:forEach>
    </h4>
</div>
<script>
